...
const Cajanegra = () => {
  ...
  const [selectedImage, setSelectedImage] = useState(null); // 🆕 Para mostrar imagen en grande
  ...
  return (
    <>
      <div className="hidden md:block w-full pl-[10px] mt-0 h-[450px] overflow-y-auto">
        <div className="bg-white text-black p-4 border-spacing-5 rounded shadow w-full max-w-[100%]">
                  ...
                  <div className="mt-3 flex gap-2 flex-wrap">
                    {task.images.map((img, index) => (
                      <img
                        ...
                        onClick={() => setSelectedImage(img.url)} // 🆕 Al hacer click se abre
                      />
                    ))}
                  </div>
                )}
